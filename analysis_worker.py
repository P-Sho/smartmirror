...
from personal_color_analysis.skin_tone_estimator import estimate_shade_from_bgr
import numpy as np
    ...
    def run(self):
        ...
        try:
            ...
            if is_warm(Lab_b, Lab_weight):
             ...
             # --- SkinToneClassifier 기반 호수 결정 ---
            shade_info = estimate_shade_from_bgr(self.img_bgr)   # numpy BGR 이미지를 넣음
            tone_num   = shade_info['shade']                # '20'|'21'|'22'|'23'

            self.finished_ok.emit(tone_num, tone)
